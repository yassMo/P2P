...
/**
 **/
public class TravailleurFacade extends Travailleur implements TravailleurFacadeInterface {
   //
   // Fields 
   //
    ...
    * null
    **/
   protected Vector<DemanderTacheListener> demanderTacheListeners = new Vector<DemanderTacheListener>();
   /**
    * disconnect
    * 
    **/
    ...
    * null
    **/
   protected Vector<EnvoyerFindeTacheListener> envoyerFindeTacheListeners = new Vector<EnvoyerFindeTacheListener>();
   /**
    * log
    * 
    **/
    ...
    * Constructor
    **/
   public   TravailleurFacade(String idName){
      setIdName(idName);
   }
   ...
   public  void recevoirTache(String expeditor, java.lang.String cmd){
      super.recevoirTache(expeditor, cmd);
   }
    ...
    * @param ev a <code>Object</code> value : data
    **/
   public  void demanderTache(String adressee){
      PropertyMap args = new PropertyMap();
      DemanderTacheEvent ev =  new DemanderTacheEvent(adressee);
      ev.setAttributes(args);
      for(int i = 0 ; i < demanderTacheListeners.size() ; i++)
      (( DemanderTacheListener ) demanderTacheListeners.elementAt(i)).demanderTache(ev);
   }
    ...
    * @param ev a <code>Object</code> value : data
    **/
   public  void envoyerFindeTache(){
      envoyerFindeTache(null);
   }
    ...
    * @param ev a <code>Object</code> value : data
    **/
   public  void envoyerFindeTache(String adressee){
      PropertyMap args = new PropertyMap();
      EnvoyerFindeTacheEvent ev =  new EnvoyerFindeTacheEvent(adressee);
      ev.setAttributes(args);
      for(int i = 0 ; i < envoyerFindeTacheListeners.size() ; i++)
      (( EnvoyerFindeTacheListener ) envoyerFindeTacheListeners.elementAt(i)).envoyerFindeTache(ev);
   }
   ...
   public  void addDemanderTacheListener(DemanderTacheListener data){
      demanderTacheListeners.add(data);
   }
   ...
   public  void removeDemanderTacheListener(DemanderTacheListener data){
      demanderTacheListeners.remove(data);
   }
   ...
   public  void addEnvoyerFindeTacheListener(EnvoyerFindeTacheListener data){
      envoyerFindeTacheListeners.add(data);
   }
   ...
   public  void removeEnvoyerFindeTacheListener(EnvoyerFindeTacheListener data){
      envoyerFindeTacheListeners.remove(data);
   }
